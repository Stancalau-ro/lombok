...
public class SideEffectsFromConstructorParamMutableParentSuite {

    private static final Class CLASS_UNDER_TEST = SideEffectFromConstructorParamMutableParent.class;
